...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  String databaseURL = "https://lab4-firebase-ceb51-default-rtdb.asia-southeast1.firebasedatabase.app/";
        ...
        buttonAdd.setOnClickListener(new View.OnClickListener() {
            ...
            private void addArtist() {
                ...
                if (!TextUtils.isEmpty(name)) {        //if exist push data to firebase database
                    // store inside id in database
                    // every time data stored the id will be unique
                    String id = databaseArtists.push().getKey();       //store
